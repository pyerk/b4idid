...
export default function GalleryView({ gallery }: GalleryViewProps) {
  const [selectedPhoto, setSelectedPhoto] = useState<Database['public']['Tables']['photos']['Row'] | null>(null)
          ...
          <div className="relative max-w-7xl max-h-full">
            ...
            <div className="bg-gray-900 rounded-lg p-4">
              {selectedPhoto.image_url ? (
                <div className="relative w-full h-[80vh] bg-gray-800 rounded overflow-hidden">
                  <Image
